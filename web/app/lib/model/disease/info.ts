...
import type { DiseaseClass, DiseaseInfo } from "@/lib/model/types"
 ...
 * Colors match the CSS variables used in the UI:
 * - Green for healthy severity (matches --healthy)
 * - Yellow for low severity (matches --low)
 * - Red for medium/high severity (matches --medium)
 *
